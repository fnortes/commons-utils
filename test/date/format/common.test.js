...
describe("it should exist a toMonth function", () => {
  ...
  it("should return a null", () => {
    ...
    expect(toMonth("test", null, "YYYY MM DD")).toBe(null);
    expect(toMonth("15/13/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMonth("32/07/1983 20:45:13", true, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMonth("15/07/1983 26:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMonth("15/07/1983 20:61:13", true, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMonth("15/07/1983 20:45:61", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
  });
  ...
  it("should return a valid month", () => {
    expect(
      toMonth("23/12/2020 17:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(12);
    expect(
      toMonth("23/12/2020 17:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("12");
    expect(
      toMonth("23/01/2021 17:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(1);
    expect(
      toMonth("23/01/2021 17:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("01");
...
describe("it should exist a toDay function", () => {
  ...
  it("should return a null", () => {
    ...
    expect(toDay("15/13/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toDay("32/07/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toDay("15/07/1983 26:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toDay("15/07/1983 20:61:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toDay("15/07/1983 20:45:61", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
  });
  ...
  it("should return a valid day", () => {
    expect(
      toDay("23/12/2020 17:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(23);
    expect(
      toDay("23/12/2020 17:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("23");
    expect(
      toDay("01/12/2020 17:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(1);
    expect(
      toDay("01/12/2020 17:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("01");
...
describe("it should exist a toHours function", () => {
  ...
  it("should return a null", () => {
    ...
    expect(toHours("15/13/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toHours("32/07/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toHours("15/07/1983 26:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toHours("15/07/1983 20:61:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toHours("15/07/1983 20:45:61", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
  });
  ...
  it("should return a valid hours", () => {
    expect(
      toHours("23/12/2020 17:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(18);
    expect(
      toHours("23/12/2020 17:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("18");
    expect(
      toHours("23/12/2020 09:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(10);
    expect(
      toHours("23/12/2020 09:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("10");
...
describe("it should exist a toMinutes function", () => {
  ...
  it("should return a null", () => {
    ...
    expect(toMinutes("15/13/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMinutes("32/07/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMinutes("15/07/1983 26:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMinutes("15/07/1983 20:61:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toMinutes("15/07/1983 20:45:61", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
  });
  ...
  it("should return a valid hours", () => {
    expect(
      toMinutes("23/12/2020 17:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(7);
    expect(
      toMinutes("23/12/2020 17:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("07");
    expect(
      toMinutes("23/12/2020 17:05:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(5);
    expect(
      toMinutes("23/12/2020 17:05:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("05");
...
describe("it should exist a toSeconds function", () => {
  ...
  it("should return a null", () => {
    ...
    expect(toSeconds("15/13/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toSeconds("32/07/1983 20:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toSeconds("15/07/1983 26:45:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toSeconds("15/07/1983 20:61:13", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
    expect(toSeconds("15/07/1983 20:45:61", false, "DD/MM/YYYY HH:mm:ss")).toBe(
      null
    );
  });
  ...
  it("should return a valid hours", () => {
    expect(
      toSeconds("23/12/2020 17:07:45 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(45);
    expect(
      toSeconds("23/12/2020 17:07:45 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("45");
    expect(
      toSeconds("23/12/2020 17:07:09 +0000", false, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe(9);
    expect(
      toSeconds("23/12/2020 17:07:09 +0000", true, "DD/MM/YYYY HH:mm:ss Z")
    ).toBe("09");
...
describe("it should exist a toFormat function", () => {
  ...
  it("should return a null", () => {
    ...
    expect(
      toFormat("15/13/1983 20:45:13", null, false, "DD/MM/YYYY HH:mm:ss")
    ).toBe(null);
    expect(
      toFormat("32/07/1983 20:45:13", null, false, "DD/MM/YYYY HH:mm:ss")
    ).toBe(null);
    expect(
      toFormat("15/07/1983 26:45:13", null, false, "DD/MM/YYYY HH:mm:ss")
    ).toBe(null);
    expect(
      toFormat("15/07/1983 20:61:13", null, false, "DD/MM/YYYY HH:mm:ss")
    ).toBe(null);
    expect(
      toFormat("15/07/1983 20:45:61", null, false, "DD/MM/YYYY HH:mm:ss")
    ).toBe(null);
  });
  ...
  it("should return a valid formatted date", () => {
    ...
    expect(
      toFormat("23/12/2020 17:07:45 +0000", null, true, "DD/MM/YYYY HH:mm:ss Z")
